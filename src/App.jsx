...
function App() {
  ...
  const handleResetSimulation = () => {
    ...
    setSelectedAsset("Tesouro Prefixado")
  }


  return (
      <div className="min-w-full max-w-3xl flex flex-col gap-10">
        ...
        <h2 className="text-blue-950 font-semibold text-[min(5vw,36px)]">Simulador de Investimentos</h2>
